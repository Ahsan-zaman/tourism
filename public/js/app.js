...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); //Show and hide hamburguer menu in small screens
...
window.addEventListener("resize", menuResize); // Rezise menu if user changing the width with responsive menu opened

function menuResize() {
  // first get the size from the window
  var window_size = window.innerWidth || document.body.clientWidth;
